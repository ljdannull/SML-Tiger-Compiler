...
fun yyAction49 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; stringStart := yypos ;continue()))
...
fun yyAction51 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (stringLiteral := !stringLiteral ^ yytext; continue())
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction19(strm, yyNO_MATCH)
                      else yyQ58(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction19(strm, yyNO_MATCH)
                  else yyQ58(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ96(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ58(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyAction45(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction20(strm, yyNO_MATCH)
                      else yyQ58(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ58(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ100(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ58(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyAction45(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction27(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ103(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
       ...
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              else yyQ11(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
      (* end case *))
