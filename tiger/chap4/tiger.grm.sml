000\000\000"
val gotoT =
"\
\\001\000\002\000\002\000\141\000\011\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\045\000\011\000\001\000\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\003\000\060\000\004\000\032\000\005\000\031\000\009\000\030\000\
\\010\000\029\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\076\000\011\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\001\000\095\000\011\000\001\000\000\000\
\\000\000\
...
\\001\000\103\000\011\000\001\000\000\000\
\\000\000\
...
\\000\000\
\\001\000\114\000\011\000\001\000\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\127\000\011\000\001\000\000\000\
\\000\000\
...
\\001\000\136\000\011\000\001\000\000\000\
\\000\000\
\\014\000\138\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\008\000\140\000\000\000\
\\000\000\
\\000\000\
\"
val numstates = 142
...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | recordparams of unit ->  ( ( A.symbol * A.exp * A.pos )  list)
 | funcparams of unit ->  (A.exp list)
 | exp_seq of unit ->  (A.exp list) | lvalue of unit ->  (A.var)
 | fundec of unit ->  (A.FunctionDec) | vardec of unit ->  (A.VarDec)
 | tyfield_seq of unit ->  (A.field list)
 | tyfields of unit ->  (A.field list) | ty of unit ->  (A.ty)
 | tydec of unit ->  (A.TypeDec) | dec of unit ->  (A.dec)
 | dec_seq of unit ->  (A.dec list) | program of unit ->  (A.exp)
end
...
rest671)) => let val  result = MlyValue.tydec (fn _ => let val  (ID
 as ID1) = ID1 ()
 val  (ty as ty1) = ty1 ()
 in ({name=A.symbol(ID), ty=ty, pos=TYPEleft})
end)
...
ID1) = ID1 ()
 in (A.NameTy(A.symbol(ID), IDleft))
end)
...
MlyValue.ty (fn _ => let val  (ID as ID1) = ID1 ()
 in (A.ArrayTy(A.symbol(ID), ARRAYleft))
end)
...
MlyValue.tyfields (fn _ => let val  ID1 = ID1 ()
 ...
 in (
A.field({name=A.symbol(ID1), escape=ref true, typ=A.symbol(ID2), pos=ID1left})::tyfield_seq
)
end)
...
rest671)) => let val  result = MlyValue.vardec (fn _ => let val  (ID
 ...
 in (
A.VarDec({name=A.symbol(ID), escape=ref true, typ=(), init=exp, pos=VARleft})
)
end)
...
MlyValue.vardec (fn _ => let val  ID1 = ID1 ()
 ...
 val  (exp as exp1) = exp1 ()
 in (
A.VarDec({name=A.symbol(ID1), escape=ref true, typ=A.symbol(ID2), init=exp, pos=ID1left})
)
end)
 in ( LrTable.NT 8, ( result, VAR1left, exp1right), rest671)
end
...
rest671)) => let val  result = MlyValue.fundec (fn _ => let val  (ID
 ...
 val  (exp as exp1) = exp1 ()
 in (
A.FunctionDec([A.fundec({name=A.symbol(ID), params=tyfields, result=(), body=exp, pos=FUNCTIONleft})])
)
end)
...
tyfields1, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, _, _)) :: ( _, ( _,
 ...
 val  (exp as exp1) = exp1 ()
 in (
A.FunctionDec([A.fundec({name=A.symbol(ID1), params=tyfields, result=A.symbol(ID2), body=exp, pos=FUNCTIONleft})])
)
end)
 in ( LrTable.NT 9, ( result, FUNCTION1left, exp1right), rest671)
end
...
rest671)) => let val  result = MlyValue.lvalue (fn _ => let val  (ID
 as ID1) = ID1 ()
 in (A.VarExp(A.SimpleVar(A.symbol(ID), IDleft)))
end)
...
lvalue1 ()
 val  (ID as ID1) = ID1 ()
 in (A.VarExp(A.FieldVar(lvalue, A.symbol(ID), IDleft)))
end)
...
, lvalue1left, _)) :: rest671)) => let val  result = MlyValue.lvalue
 ...
 val  (exp as exp1) = exp1 ()
 in (A.VarExp(A.SubscriptVar(lvalue, exp, LBRACKleft)))
end)
 in ( LrTable.NT 10, ( result, lvalue1left, RBRACK1right), rest671)

end
|  ( 21, ( ( _, ( MlyValue.exp_seq exp_seq1, _, exp_seq1right)) :: ( _
, ( MlyValue.ntVOID exp1, _, _)) :: ( _, ( _, SEMICOLON1left, _)) :: 
rest671)) => let val  result = MlyValue.exp_seq (fn _ => let val  (exp
 as exp1) = exp1 ()
...
|  ( 22, ( rest671)) => let val  result = MlyValue.exp_seq (fn _ => (
[]))
 in ( LrTable.NT 11, ( result, defaultPos, defaultPos), rest671)
end
|  ( 23, ( ( _, ( MlyValue.funcparams funcparams1, _, funcparams1right
)) :: ( _, ( MlyValue.ntVOID exp1, _, _)) :: ( _, ( _, COMMA1left, _))
 :: rest671)) => let val  result = MlyValue.funcparams (fn _ => let
 val  (exp as exp1) = exp1 ()
...
|  ( 24, ( rest671)) => let val  result = MlyValue.funcparams (fn _ =>
 ([]))
 in ( LrTable.NT 12, ( result, defaultPos, defaultPos), rest671)
end
|  ( 25, ( ( _, ( MlyValue.recordparams recordparams1, _, 
recordparams1right)) :: ( _, ( MlyValue.ntVOID exp1, _, _)) :: _ :: (
 _, ( MlyValue.ID ID1, IDleft, _)) :: ( _, ( _, COMMA1left, _)) :: 
rest671)) => let val  result = MlyValue.recordparams (fn _ => let val 
 (ID as ID1) = ID1 ()
 val  (exp as exp1) = exp1 ()
 val  (recordparams as recordparams1) = recordparams1 ()
 in ((A.symbol(ID), exp, IDleft)::recordparams)
end)
 in ( LrTable.NT 13, ( result, COMMA1left, recordparams1right), 
rest671)
end
|  ( 26, ( rest671)) => let val  result = MlyValue.recordparams (fn _
 => ([]))
...
|  ( 28, ( rest671)) => let val  result = MlyValue.else_clause (fn _
 => (()))
...
|  ( 31, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.exp_seq 
...
|  ( 37, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.funcparams 
...
|  ( 50, ( ( _, ( _, _, RBRACE1right)) :: ( _, ( MlyValue.recordparams
...
|  ( 52, ( ( _, ( MlyValue.ntVOID exp2, _, exp2right)) :: _ :: _ :: (
 _, ( MlyValue.ntVOID exp1, _, _)) :: _ :: ( _, ( MlyValue.lvalue 
...
MlyValue.ntVOID (fn _ => ( let val  lvalue1 = lvalue1 ()
 ...
 in ( LrTable.NT 0, ( result, lvalue1left, exp2right), rest671)
end
...
|  ( 54, ( ( _, ( MlyValue.else_clause else_clause1, _, 
else_clause1right)) :: ( _, ( MlyValue.ntVOID exp2, _, _)) :: _ :: ( _
...
|  ( 58, ( ( _, ( _, _, END1right)) :: ( _, ( MlyValue.exp_seq 
exp_seq1, _, _)) :: ( _, ( MlyValue.ntVOID exp1, _, _)) :: _ :: ( _, (
 MlyValue.dec_seq dec_seq1, _, _)) :: ( _, ( _, LET1left, _)) :: 
rest671)) => let val  result = MlyValue.ntVOID (fn _ => ( let val  
dec_seq1 = dec_seq1 ()
 val  exp1 = exp1 ()
...
|  ( 59, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.ntVOID exp1,
